    ...
    <div className='px-4 md:px-12 py-8   '>
      <div className='border-b-2 w-full flex gap-6  flex-col md:flex-row pb-12'>
        <div className='md:w-2/3 '>
          <h2 className='md:text-2xl font-primary mb-4'>Latest Post</h2>
        ...
        <div className='hidden md:flex flex-col gap-4 md:w-1/3'>
          <h2 className='md:text-2xl font-primary '>Search the blog</h2>
          <Search />
          <h2 className='md:text-2xl font-primary'>Latest Posts</h2>
