...
import type { Tour } from '../containers/TourList';
      ...
      <div className='flex gap-2 p-4 justify-between  rounded-lg border-[1px] border-separate'>
        ...
        <div className=' text-right flex items-center gap-2'>
          <div className='flex flex-col items-center justify-end'>
            <p className='font-semibold text-lg ml-1'>{tour.rating}</p>
            <StarRating rating={tour.rating} size={24} />
          </div>
          <div className='w-[1px] h-full bg-black/10' />
          <div className='flex flex-col items-center justify-end'>
            <p className='font-semibold text-lg ml-1'>{tour.reviews}</p>
