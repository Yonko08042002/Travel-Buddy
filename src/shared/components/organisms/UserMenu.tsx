...
import { AlignJustify, ChevronDown, LogOutIcon, UserPen } from 'lucide-react';
...
export const UserMenu = ({ user }: UserMenuProps) => {
  ...
  return (
    <div className='relative flex gap-2 items-center border-black border-[1px] p-1 rounded-full'>
      <DropdownMenu>
      ...
      <div className='absolute bg-slate-200 rounded-full flex justify-center items-center bottom-[-5px] right-[-5px]'>
